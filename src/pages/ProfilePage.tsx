...
import { EmailAuthProvider, updatePassword, reauthenticateWithCredential, signOut } from "firebase/auth";
      ...
      if (newPassword !== newConfPassword) {
         ...
         setErrorMessageOldPW("");       
            ...
            .then(() => {
               ...
               signOut(auth)
               .then(() => {
                  console.log("re-login required after successfully changing the password");
               }).catch((error) => {
      ...
      <>
         <Paper component={Stack} direction="column" justifyContent="center">
            ...
            <FlexBox>
               ...
               <DialogContent>
                  <DialogContentText>
                  Wählen Sie mindestens 8 Zeichen. 
                  Verwenden Sie kein Passwort von einer anderen Website und kein einfach zu 
                     ...
                     InputProps={{ 
                        endAdornment: (
                          <InputAdornment position="end">
                            ...
                            >
                              {showNewConfPassword ? <VisibilityIcon /> : <VisibilityOffIcon />}
                            </IconButton>
                          </InputAdornment>
                        )
                      }}
